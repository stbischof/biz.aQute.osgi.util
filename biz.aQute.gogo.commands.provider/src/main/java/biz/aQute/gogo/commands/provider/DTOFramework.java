...
public class DTOFramework {
	...
	@Descriptor(value = "deliveres the FrameworkDTO")
	...
	@Descriptor(value = "deliveres the BundleDTOs")
	public List<BundleDTO> bundleDTO() {
		return frameworkDTO().bundles;
	}

	@Descriptor(value = "deliveres the BundleDTO by id")
	...
	@Descriptor(value = "deliveres the ServiceReferenceDTOs")
	public List<ServiceReferenceDTO> serviceReferenceDTO() {
		return frameworkDTO().services;
	}

	@Descriptor(value = "deliveres the ServiceReferenceDTO by id")
